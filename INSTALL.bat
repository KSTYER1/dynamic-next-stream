...
chcp 65001 >nul
title Dynamic Next Stream (Dock Plugin) - Installer
...
echo ============================================================
echo.
echo Enthaelt ein Dock:
echo   - Naechster Stream  (Wochenplan-Editor mit Live-Vorschau)
echo.
echo Hinweis: Dieses Plugin braucht Qt6 (von OBS mitgeliefert).
echo.
...
echo.
echo OBS neu starten. Im Menue Ansicht -^> Andocken muss
echo "Naechster Stream" waehlbar sein.
echo.
pause
exit /b 0
